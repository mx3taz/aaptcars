...
foreach ($fix in $spacingFixes) {
    $content = $content.Replace($fix[0], $fix[1])
}

# 4. Awkward rebranding phrases
$rebrandingFixes = @(
    @("Expertise forts de notre expertise", "Expertise reconnue"),
    @("expertise forts de notre expertise", "expertise reconnue"),
    @("AAPT – Votre spécialiste en pièces détachées automobiles en Tunisie forts de notre expertise.", "AAPT – Votre spécialiste en pièces détachées automobiles en Tunisie."),
    @("AAPT – Votre expert en pièces détachées automobiles forts de notre expertise.", "AAPT – Votre expert en pièces détachées automobiles en Tunisie."),
...
foreach ($fix in $rebrandingFixes) {
    $content = $content.Replace($fix[0], $fix[1])
}
...
# 7. Final cleanup
# Replace double spaces where appropriate
